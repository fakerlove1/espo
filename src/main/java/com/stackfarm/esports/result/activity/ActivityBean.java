...
public class ActivityBean {
    ...
    public ActivityBean(Long id, String name, Long launcherId, Long launchedTime, Long beginTime, Long endTime, Long enrollBeginTime,
                        Long enrollEndTime, String scope, String types, String location, String detailedLocation,
                        Integer level, String note, Integer sizeOfPeople, String state, String participateIds,
                        String staffTypes, String staffTypesCount, String requirement, BigDecimal cost,
                        BigDecimal reward, Integer point, String contactWay, String introduction, String poster,
                        String picture, String plan) {
        this.id = id;
        this.name = name;
        this.launcherId = launcherId;
        this.launchedTime = launchedTime;
