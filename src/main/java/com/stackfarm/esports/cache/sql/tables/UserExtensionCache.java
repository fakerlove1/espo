 ...
 * @author 十三月之夜
 */
public class UserExtensionCache extends SqlCache {

    private final String id;

    private static final String SQL_CACHE_PREFIX = SqlCache.SQL_CACHE_PREFIX + "USER_EXTENSION_CACHE_";

    public UserExtensionCache(String id) {
        this.id = id;
    }
