 ...
 * @author 十三月之夜
 */
public class UserActivityCache extends SqlCache {

    private final String id;

    private static final String SQL_CACHE_PREFIX = SqlCache.SQL_CACHE_PREFIX + "USER_ACTIVITY_CACHE_";

    public UserActivityCache(String id) {
        this.id = id;
    }
