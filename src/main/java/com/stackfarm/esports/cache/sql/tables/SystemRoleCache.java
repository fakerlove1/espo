 ...
 * @author 十三月之夜
 */
public class SystemRoleCache extends SqlCache {

    private final String id;

    private static final String SQL_CACHE_PREFIX = SqlCache.SQL_CACHE_PREFIX + "SYSTEM_ROLE_";

    public SystemRoleCache(String id) {
        this.id = id;
    }
