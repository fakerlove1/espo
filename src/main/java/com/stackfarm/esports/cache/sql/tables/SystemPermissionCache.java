 ...
 * @author 十三月之夜
 */
public class SystemPermissionCache extends SqlCache {

    private final String id;

    private static final String SQL_CACHE_PREFIX = SqlCache.SQL_CACHE_PREFIX + "SYSTEM_PERMISSION_";

    public SystemPermissionCache(String id) {
        this.id = id;
    }
