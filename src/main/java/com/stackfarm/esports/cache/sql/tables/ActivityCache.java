 ...
 * @author 十三月之夜
 */
public class ActivityCache extends SqlCache {

    private final String id;

    private static final String SQL_CACHE_PREFIX = SqlCache.SQL_CACHE_PREFIX + "ACTIVITY_";

    public ActivityCache(String id) {
        this.id = id;
    }
