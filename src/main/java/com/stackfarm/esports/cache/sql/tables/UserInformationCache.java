 ...
 * @author 十三月之夜
 */
public class UserInformationCache extends SqlCache {

    private final String id;

    private static final String SQL_CACHE_PREFIX = SqlCache.SQL_CACHE_PREFIX + "USER_INFORMATION_";

    public UserInformationCache(String id) {
        this.id = id;
    }
