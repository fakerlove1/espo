 ...
 * @author 十三月之夜
 */
public class UserMsgCache extends SqlCache {

    private final String id;

    private static final String SQL_CACHE_PREFIX = SqlCache.SQL_CACHE_PREFIX + "USER_MSG_";

    public UserMsgCache(String id) {
        this.id = id;
    }
