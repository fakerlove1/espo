 ...
 * @author 十三月之夜
 */
public class UserAuthsCache extends SqlCache {

    private final String id;

    private static final String SQL_CACHE_PREFIX = SqlCache.SQL_CACHE_PREFIX + "USER_AUTHS_";

    public UserAuthsCache(String id) {
        this.id = id;
    }
