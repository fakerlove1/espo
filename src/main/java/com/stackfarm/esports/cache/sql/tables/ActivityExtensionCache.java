 ...
 * @author 十三月之夜
 */
public class ActivityExtensionCache extends SqlCache {

    private final String id;

    private static final String SQL_CACHE_PREFIX = SqlCache.SQL_CACHE_PREFIX + "ACTIVITY_EXTENSION_";

    public ActivityExtensionCache(String id) {
        this.id = id;
    }
