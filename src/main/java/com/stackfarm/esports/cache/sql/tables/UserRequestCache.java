 ...
 * @author 十三月之夜
 */
public class UserRequestCache extends SqlCache {

    private final String id;

    private static final String SQL_CACHE_PREFIX = SqlCache.SQL_CACHE_PREFIX + "USER_REQUEST_";

    public UserRequestCache(String id) {
        this.id = id;
    }
