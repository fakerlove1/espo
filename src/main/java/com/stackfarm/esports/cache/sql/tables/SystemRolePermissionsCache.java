 ...
 * @author 十三月之夜
 */
public class SystemRolePermissionsCache extends SqlCache {

    private final String id;

    private static final String SQL_CACHE_PREFIX = SqlCache.SQL_CACHE_PREFIX + "SYSTEM_ROLE_PERMISSIONS_";

    public SystemRolePermissionsCache(String id) {
        this.id = id;
    }
