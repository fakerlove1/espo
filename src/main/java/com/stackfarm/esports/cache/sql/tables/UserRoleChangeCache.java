 ...
 * @author 十三月之夜
 */
public class UserRoleChangeCache extends SqlCache {

    private final String id;

    private static final String SQL_CACHE_PREFIX = SqlCache.SQL_CACHE_PREFIX + "USER_ROLE_CHANGE_";

    public UserRoleChangeCache(String id) {
        this.id = id;
    }
