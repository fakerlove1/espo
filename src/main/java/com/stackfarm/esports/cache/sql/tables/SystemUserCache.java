 ...
 * @author 十三月之夜
 */
public class SystemUserCache extends SqlCache {

    private final String id;

    private static final String SQL_CACHE_PREFIX = SqlCache.SQL_CACHE_PREFIX + "SYSTEM_USER_";

    public SystemUserCache(String id) {
        this.id = id;
    }
